...
func Nvalor_arreglo(le *arraylist.List) ValorArreglo {
...
func (vv ValorArreglo) Ejecutar_Expresion(ent *entorno.Entorno) simbolos.Valor {
	data, tipo := vv.Obteniendo_Valores(ent)

	return simbolos.Valor{Valor: data, Tipo: tipo}
}

func (vv ValorArreglo) Compilar_Expresion(ent *entorno.Entorno, gen *generador.Generador_C3D) simbolos.ValoresC3D {
